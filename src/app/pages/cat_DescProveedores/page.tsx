...
export default function CatDescProveedores() {
  ...
  const [selectedRow, setSelectedRow] = useState<DescuentoProveedor | null>(
    null,
  );
  ...
  const fetchDescuentos = async () => {
    try {
      ...
      const res = await consumoApi.get(
        '/api/CatDescuentoProveedores/sp_bw_cat_proveedores_descuentos_sel',
      );
  ...
  const handleProcessRowUpdate = async (
    newRow: DescuentoProveedor,
    oldRow: DescuentoProveedor,
  ) => {
    try {
      const params = {
            ...
            <Box>
              ...
              >
                <Checkbox
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, aplica_costo: e.target.checked })
                  }
                  sx={{
                    color: '#333',
                    p: 0,
        ...
        >
          <Button
            ...
            sx={{
              ...
              fontWeight: 500,
              transition: 'all 0.3s ease',
              '&:hover': { backgroundColor: '#e0e0e0', color: '#333' },
            }}
          >
            Cancelar
          </Button>
      ...
      >
        ...
        <DialogContent sx={{ p: 3, bgcolor: '#fff', mt: 2 }}>
          <Typography sx={{ fontSize: '1.1rem', mb: 2 }}>
            ¿Está seguro que desea eliminar el descuento "
